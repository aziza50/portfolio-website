...
const Work = ({isDarkMode}) => {
  return (
    ...
    >
      ...
      className = 'grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 my-10 gap-4 dark:text-black'>
        {workData.map((project, index)=> (
            ...
            style = {{backgroundImage: `url(${project.bgImage})`}}>
                ...
                <div className="border rounded-full border-black w-9 h-9 flex items-center justify-center shadow-[2px_2px_0_#000] group-hover:bg-pink-300 transition-colors duration-300">
                <a href = {project.link}>
