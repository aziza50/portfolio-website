  ...
  return (
    ...
    <Image src={assets.user_image} alt="user" className="w-full rounded-3xl" />
        ...
        transition = {{duration:0.6, delay:0.8}}>
            <p className = 'mb-10 max-w-22xl font-Ovo'>
            I am passionate about technology and exploring ways I could benefit others, particularly in areas of healthcare and environment sustainability.
            </p>
